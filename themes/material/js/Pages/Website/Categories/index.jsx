...
export default function() {
    ...
    return (
        <div className='max-w-screen-xl mx-auto flex flex-col'>
            <h1 class="text-5xl font-extrabold dark:text-white mt-16 mx-auto">Categories</h1>
                            ...
                            {data.categories.data.map((category, index) => {
                                return (
                                    <div key={index} class="max-w-sm">
                                        ...
                                        <Button to={`/categories/${category.id}`} className='flex w-fit ml-auto mr-auto my-auto'>
